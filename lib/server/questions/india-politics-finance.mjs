/* LEDGER — Politics & Money Desk question bank v1
 * 90 items: 45 politics (2000-2026: audits/courts, parties, ministries, elections, schemes timeline)
 * + 45 finance (schemes, markets, investment literacy, budgets).
 * Every item sourced to an official record; mutable facts date-stamped in explanations.
 * REGISTRATION: extend tests/bank.test.mjs id regex with 'pl|gs|mm|ia|bd' prefixes,
...
},
{
  ...
  "correctIndex": 0,
  "explanation": "The ECI put polling-station turnout at 65.79% (male 68.80%, female 65.78%) and said over 642 million electors voted. Detailed statistical reports including postal ballots follow on the ECI website.",
  "sourceUrl": "https://www.eci.gov.in",
...
},
{
  ...
  "subtopic": "Schemes & Policy Timeline (politics of)",
  "difficulty": "simple",
  "question": "The Right to Information Act, 2005 — passed by Parliament on 15 June 2005 — came fully into force on:",
  "options": [
    "12 October 2005",
    "26 January 2006",
    "15 August 2005",
...
},
{
  ...
  "subtopic": "Schemes & Policy Timeline (politics of)",
  "difficulty": "simple",
  "question": "The Goods and Services Tax, enabled by the Constitution (101st Amendment) Act that entered into force on 8 September 2016, was rolled out nationwide on:",
  "options": [
    "1 April 2017",
    "1 July 2017",
    "8 September 2016",
...
},
{
  ...
  "options": [
    "The annual fee the fund house charges, expressed as a percentage of the fund's assets",
