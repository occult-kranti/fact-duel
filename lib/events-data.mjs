...
// 2026-09-16: Baseball and Formula 1 entries added from the fetched Wikipedia season pages (2026 MLB
// season and postseason, 2026 Formula One World Championship, 2027 MLB season, 2027 Formula One World
// Championship, 2027 Cricket World Cup, 2026-27 NBA and UEFA Champions League). Upcoming entries carry
// no result and say so in the blurb; nothing here claims an outcome that has not happened.
// Same day: four entries filed under the wrong sport were removed (an ice-hockey final under Basketball,
// a cycling race and a multi-sport games under Football, a golf cup under Tennis) — filler that became
// wrong data once the product is sports-only.
export const CALENDAR_ASOF = '2026-09-16';
...
export const EVENTS = Object.freeze([
  ...
  // ---- Formula 1 (added 2026-09-16; dates from the 2026 season page; a race weekend is shown as
  // the two days before the race through race day) ----
  {
    id: 'f1-2026-season',
    name: 'Formula 1 2026 World Championship',
    domain: 'sports',
    topic: 'Formula 1',
    start: '2026-03-08',
    end: '2026-12-06',
    blurb: 'Twenty-three rounds from Melbourne to Abu Dhabi under the new 2026 regulations: smaller, lighter cars with active aero and a 50/50 electric-combustion split.',
    whyQuiz: 'The 2026 rule reset, the new power-unit makers, the Madrid street circuit, which teams the regulations rewarded, and the shape of the title fight.',
    sourceUrl: 'https://en.wikipedia.org/wiki/2026_Formula_One_World_Championship',
  },
  {
    id: 'f1-2026-spanish-gp-madrid',
    name: 'Spanish Grand Prix 2026 (Madrid)',
    domain: 'sports',
    topic: 'Formula 1',
    start: '2026-09-11',
    end: '2026-09-13',
    blurb: 'Round 14 of 23, and the first Spanish Grand Prix at the new Madrid street circuit; Barcelona-Catalunya kept its own June date.',
    whyQuiz: 'Why 2026 has two Spanish rounds, street-circuit firsts, and how Madrid compares with Baku and Singapore on overtaking and safety cars.',
    sourceUrl: 'https://en.wikipedia.org/wiki/2026_Formula_One_World_Championship',
  },
  {
    id: 'f1-2026-azerbaijan-gp',
    name: 'Azerbaijan Grand Prix 2026',
    domain: 'sports',
    topic: 'Formula 1',
    start: '2026-09-24',
    end: '2026-09-26',
    blurb: 'Round 15 of 23 on the Baku street circuit, run on a Saturday this year. Upcoming: no result yet.',
    whyQuiz: 'Baku’s two-kilometre straight, the castle section, the 2017 Vettel-Hamilton clash, and why Saturday races exist.',
    sourceUrl: 'https://en.wikipedia.org/wiki/2026_Formula_One_World_Championship',
  },
  {
    ...
    blurb: 'Round 16 of 23 at Sakhir, moved from its usual season-opening slot. Upcoming: no result yet.',
    whyQuiz: 'Bahrain’s night race, Grosjean’s 2020 escape, the 2021 Hamilton-Verstappen opener, and why the calendar moved it to autumn.',
    sourceUrl: 'https://en.wikipedia.org/wiki/2026_Formula_One_World_Championship',
  },
  {
    id: 'f1-2026-singapore-gp',
    name: 'Singapore Grand Prix 2026',
    domain: 'sports',
    topic: 'Formula 1',
    start: '2026-10-09',
    end: '2026-10-11',
    blurb: 'Round 17 of 23 at Marina Bay, the original night race. Upcoming: no result yet.',
    whyQuiz: 'Crashgate 2008, the humidity and the two-hour limit, why Marina Bay is the hardest race of the year on the drivers.',
    sourceUrl: 'https://en.wikipedia.org/wiki/2026_Formula_One_World_Championship',
  },
  {
    id: 'f1-2026-abu-dhabi-gp-finale',
    name: 'Abu Dhabi Grand Prix 2026 — season finale',
    domain: 'sports',
    topic: 'Formula 1',
    start: '2026-12-04',
    end: '2026-12-06',
    blurb: 'Round 23 of 23 at Yas Marina, the last race of the first season under the 2026 regulations. Upcoming: no result yet.',
    whyQuiz: 'Abu Dhabi 2021 and the safety-car decision, title deciders through history, and what a first-year regulation set usually settles.',
    sourceUrl: 'https://en.wikipedia.org/wiki/2026_Formula_One_World_Championship',
  },
  {
    id: 'f1-2027-season',
    name: 'Formula 1 2027 World Championship',
    domain: 'sports',
    topic: 'Formula 1',
    start: '2027-03-14',
    end: '2027-12-12',
    blurb: 'Twenty-four rounds, 14 March to 12 December 2027 — the second season of the 2026 regulations. Upcoming.',
    whyQuiz: 'Second-year regulation convergence, which teams historically catch up in year two, and calendar changes.',
    sourceUrl: 'https://en.wikipedia.org/wiki/2027_Formula_One_World_Championship',
  },
  // ---- Baseball (added 2026-09-16; dates from the 2026 and 2027 MLB season pages) ----
  {
    id: 'mlb-2026-regular-season',
    name: 'MLB 2026 regular season',
    domain: 'sports',
    topic: 'Baseball',
    start: '2026-03-26',
    end: '2026-09-27',
    blurb: 'Opening Day 26 March (one game on the 25th) to the final day on 27 September; the All-Star Game was 14 July.',
    whyQuiz: 'Pennant races, the record books, the steroid-era Hall of Fame debate, and the last time a record fell in September.',
    sourceUrl: 'https://en.wikipedia.org/wiki/2026_Major_League_Baseball_season',
  },
  {
    ...
    blurb: 'Wild Card series from 29 September through to the World Series. Upcoming: no result yet.',
    whyQuiz: 'October history: the Black Sox, Buckner 1986, the 2004 Red Sox, the Cubs in 2016, the Astros in 2017, and how the Wild Card format changed the month.',
    sourceUrl: 'https://en.wikipedia.org/wiki/2026_Major_League_Baseball_postseason',
  },
  {
    ...
    blurb: 'Best of seven from 23 October, Game 7 if needed on 31 October. Upcoming: no result yet.',
    whyQuiz: 'Game 7s through history, the Curse of the Bambino, the Yankees’ 27, walk-off endings, and the longest World Series droughts.',
    sourceUrl: 'https://en.wikipedia.org/wiki/2026_World_Series',
  },
  {
    id: 'mlb-2027-season',
    name: 'MLB 2027 season',
    domain: 'sports',
    topic: 'Baseball',
    start: '2027-03-25',
    end: '2027-09-26',
    blurb: 'Opening Day 25 March 2027 (a standalone game on the 24th); All-Star Game 13 July; regular season ends 26 September. The CBA expires 1 December 2026, so a lockout is possible.',
    whyQuiz: 'The 1994 strike, the 2021-22 lockout, Opening Day traditions, and the records within reach in 2027.',
    sourceUrl: 'https://en.wikipedia.org/wiki/2027_Major_League_Baseball_season',
  },
  {
    id: 'world-series-2027',
    name: 'World Series 2027',
    domain: 'sports',
    topic: 'Baseball',
    start: '2027-10-22',
    end: '2027-10-30',
    blurb: 'Scheduled 22-30 October 2027. Upcoming.',
    whyQuiz: 'The Fall Classic’s origins, the 1903 first series, and the franchises still waiting for a first title.',
    sourceUrl: 'https://en.wikipedia.org/wiki/2027_Major_League_Baseball_season',
  },
  // ---- Basketball, Football, Cricket additions (added 2026-09-16; dates from the season pages) ----
  {
    id: 'nba-cup-2026',
    name: 'NBA Cup 2026',
    domain: 'sports',
    ...
    blurb: 'The in-season tournament, group play from 30 October to a final on 11 December. Upcoming: no result yet.',
    whyQuiz: 'Why the NBA added an in-season cup, the first two winners, the coloured courts, and how group play seeds the knockouts.',
    sourceUrl: 'https://en.wikipedia.org/wiki/2026%E2%80%9327_NBA_season',
  },
  {
    id: 'ucl-final-2027-madrid',
    name: 'UEFA Champions League final 2027 (Madrid)',
    domain: 'sports',
    topic: 'Football',
    start: '2027-06-05',
    end: '2027-06-05',
    blurb: 'The 2026-27 final, at the Metropolitano in Madrid on 5 June 2027. Upcoming.',
    whyQuiz: 'Madrid finals past, Istanbul 2005 and the comebacks since, the league-phase format’s second season, and record winners.',
    sourceUrl: 'https://en.wikipedia.org/wiki/2026%E2%80%9327_UEFA_Champions_League',
  },
  {
    id: 'cricket-world-cup-2027',
    name: 'ICC Cricket World Cup 2027',
    domain: 'sports',
    topic: 'Cricket',
    start: '2027-10-04',
    end: '2027-11-21',
    blurb: 'Fourteen teams in South Africa, Zimbabwe and Namibia, 4 October to 21 November 2027. Upcoming.',
    whyQuiz: '1983, 2011 and 2019’s boundary-count final, South Africa’s 1999 semi-final, and the return to a 14-team format.',
    sourceUrl: 'https://en.wikipedia.org/wiki/2027_Cricket_World_Cup',
  },
]);
